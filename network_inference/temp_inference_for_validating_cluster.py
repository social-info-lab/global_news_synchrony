...
# sbatch -o script_output/load_model_inference/load_model_inference_170_180.out temp_inferene_for_validating_cluster_script.sh "../ner_art_sampling/network_pairs/candidates/candidates-top10-ne-filtered_170_180/*" 170 180 overall positive 4 56
...
if __name__ == '__main__':
    ...
    for file in files:
        print(file)
        output_file = file.replace("sample","sample_inference")
            ...
            with open(file, "r") as fh:
                for line in fh:
                    ...
                    try:
                        ...
                        a1_file = pair["art1"][0]
                        a1_lineno = pair["art1"][1]
                        a2_file = pair["art2"][0]
                        a2_lineno = pair["art2"][1]
    ...
    print("average dissimilarity: ", np.mean(sim_list))
